...
enum Opcode      {ADDI = 0, ADDF = 1, SUBI = 2, SUBF = 3, MULTI = 4, MULTF = 5, DIVI = 6, DIVF = 7, STOREI = 8, STOREF = 9, GT = 10, GE = 11, LT = 12, LE = 13, NE = 14, EQ = 15, JUMP = 16, LABEL = 17, READI = 18, READF = 19, WRITEI = 20, WRITEF = 21, WRITES = 22 ,PUSH=23 , POP=24 , JSR=25, LINK=26, UNLINK=27, RET=28, HALT=29 , PUSHREG=30, POPREG=31};
...
class IRNode{
		public:
				...
				~IRNode(){};
				string toIRString();
				vector<AssemblyNode> toAssembly(string r1, string r2, string r3);
				string getDef();
